...
<div class="community-container">
  ...
  <?php
    ...
    if (!empty($terms) && !is_wp_error($terms)) {
      ...
      foreach ($terms as $term) {
        echo '<li><a href="' . esc_url(home_url('/oe_community/tag/').$term->slug). '"';
  ...
  ?>
  <h1 class="community-archive-title">タグ：<?php echo single_term_title( '', false ); ?>の記事一覧</h1>
  <?php if ( have_posts() ) : ?>
